...
<body bgcolor="#FFFFCC" onLoad="regFrm.usid.focus()">
	<div align="center">
		<br /><br />
		<form id="register" name="regFrm" method="post" action="/parking/api/member/edit.do">
			<table cellpadding="5">
				<tr>
					<td bgcolor="#FFFFCC">
						<table border="1" cellspacing="0" cellpadding="2" width="900">
							<tr bgcolor="#996600">
								<td align="center" colspan="3"><font color="#FFFFFF"><b>회원 정보 수정</b></font></td>
							</tr>
							<tr>
								<input name="uid" style="display:none;" value="${numb }" readonly>
								<td width="20%">아이디</td>
								<td width="50%">
									<input id="usid" size="15" value="${user_id }" readonly> 
								</td>
								<td width="30%">아이디는 수정 불가합니다.</td>
							</tr>
							<tr>
								<td>패스워드</td>
								<td><input type="password" id="pw_A" name="user_pw" size="15" value="${user_pw }"></td>
								<td>패스워드를 적어주세요.</td>
							</tr>
							<tr>
								<td>패스워드 확인</td>
								<td><input type="password" id="pw_B" name="repwd" size="15" value="${user_pw }"></td>
								<td>패스워드를 확인합니다.</td>
							</tr>
							<tr>
								<td>이름</td>
							...
							<tr>
								<td>전화번호</td>
								<td><input id="p_num" name="p_num" size="15" value="${p_num }"> ex) 010-0000-0000
								</td>
								<td>전화번호를 적어주세요.</td>
							</tr>
							<tr>
							...
							<tr>
								<td>생년월일</td>
								<td><input id="birthday" name="birth_day" size="6" value="${birth_day }">
									ex)830815</td>
								<td>생년월일를 적어 주세요.</td>
							</tr>
							<tr>
								<td>Email</td>
								<td><input id="email" name="email" size="30" value="${email }">
								</td>
								<td>이메일를 적어 주세요.</td>
							</tr>
							<tr>
								<td>차량번호</td>
								<td><input id="car_num" name="car_num" size="29" value="${car_num }"> 
							...
							<tr>
								<td>주소</td>
								<td>
									<input id="post_num" name="post_id" size="10" placeholder="우편번호" value="${post_no }" readonly> <button type="button" onclick="postcode_search()">우편번호 검색</button>
